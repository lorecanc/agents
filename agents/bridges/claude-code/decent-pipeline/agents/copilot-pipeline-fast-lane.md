---
name: copilot-pipeline-fast-lane
...
## Escalation
If needed: `@decent-pipeline:copilot-pipeline-explorer`, `@decent-pipeline:copilot-pipeline-planner`, or `@decent-pipeline:copilot-pipeline-reasoner`.
```
