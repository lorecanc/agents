...
description: "Frontend debugging and visual validation agent. Uses Chrome DevTools for performance audits, a11y testing, layout verification, and console error detection. Called in the frontend lane before and after code changes."
---

# copilot-pipeline-chrome_devtools
