---
name: critic
description: "Final validation agent for complex work. Checks whether the result satisfies the original request without overengineering."
---

# copilot-pipeline-critic
