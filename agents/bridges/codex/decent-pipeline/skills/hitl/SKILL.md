---
name: hitl
description: "Human-in-the-loop checkpoint agent. Generates Literate Diff Reports and interactive comprehension quizzes to ensure the developer understands all changes before proceeding. Speed regulator for the pipeline."
---

# copilot-pipeline-hitl
