...
description: "Security vulnerability scanner. Reviews diffs for OWASP Top 10 and CWE patterns. Uses CWE-search MCP for classification. Does not edit files."
---

# `copilot-pipeline-security_auditor`
