...
def _parse_border_left(style_map: Dict[str, str]) -> Optional[Tuple[float, str]]:
    ...
    pseudo_bg = style_map.get("pseudo-before-background", "") or style_map.get("pseudo-before-background-color", "")
...
def _resolve_padding(style_map: Dict[str, str]) -> Optional[Tuple[Optional[float], Optional[float], Optional[float], Optional[float]]]:
...
def _normalize_padding(padding: Tuple[Optional[float], Optional[float], Optional[float], Optional[float]]) -> Tuple[float, float, float, float]:
    top, right, bottom, left = padding
    return (top or 0.0, right or 0.0, bottom or 0.0, left or 0.0)
...
def _parse_box_values(value: str) -> Optional[Tuple[Optional[float], Optional[float], Optional[float], Optional[float]]]:
    if not value:
        return None
