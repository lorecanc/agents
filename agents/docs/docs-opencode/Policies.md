...
Policies are separate from [permissions](https://opencode.ai/docs/permissions). Permissions control what tools can do during a session, while policies control whether OpenCode may use a resource such as an LLM provider.
