...
The command shows what will be removed and asks for confirmation. See the [CLI reference](https://opencode.ai/docs/cli#uninstall) for options to keep your configuration or application data.
