...
from html_docx_constants import _LIST_BASE_HANGING_TWIPS, _LIST_BASE_LEFT_TWIPS, _NAMED_COLORS, _PADDING_SCALE
from html_docx_css import (
    _border_sz, _normalize_font_family, _parse_background_color, _parse_border_left,
    _parse_box_values, _parse_color, _parse_float, _parse_font_size_pt,
    _parse_length_to_pt, _parse_padding, _parse_px_to_pt,
)
...
def _parse_paragraph_border(border: str) -> Optional[Tuple[float, str]]:
    if not border:
        return None
    parts = border.split()
